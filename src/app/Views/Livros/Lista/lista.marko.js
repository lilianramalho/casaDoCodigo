...
function render(input, out, __component, component, state) {
  ...
  out.w("<html><head><meta charset=utf-8></head><body><h1>Listagem de livros</h1><table id=livros><tr><td>ID</td><td>titulo</td><td>Preço</td><td>Editar</td><td>Remover</td></tr>");
  ...
  marko_forOf(data.livros, function(livro) {
    ...
    out.w("<tr" +
      ...
      "</td><td><a" +
      marko_attr("href", "/livros/form/" + (livros.id == null ? "" : livros.id)) +
