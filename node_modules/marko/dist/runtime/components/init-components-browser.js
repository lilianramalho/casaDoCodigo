...
var createFragmentNode = require("../vdom/morphdom/fragment").ao_;
...
function initComponent(componentDef, doc) {
  ...
  if (domEvents) {
    ...
    if (eventListenerHandles.length) {
      component.Q_ = eventListenerHandles;
    }
  }
...
function initServerRendered(renderedComponents, doc) {
  ...
  (renderedComponents.w || []).map(function (componentDef) {
    componentDef = ComponentDef._L_(componentDef, meta.ar_, meta.aq_, registry);
...
function hydrateComponentAndGetMount(componentDef, doc) {
  ...
  if (rootNode) {
    ...
    if (componentDef._G_ & FLAG_WILL_RERENDER_IN_BROWSER) {
      component._a_ = doc;
      renderResult = component._s_(component.U_, true);
      trackComponent(componentDef);
