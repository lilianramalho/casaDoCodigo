...
module.exports = function defineRenderer(renderingLogic) {
  ...
  if (!renderer) {
    ...
    renderer = function renderer(input, out) {
      ...
      var isReceivingNewInput = !component || component.au_;
      var parentComponentDef;

      if (component) {
        delete component.au_;
      }
      ...
      if (!component && componentLookup) {
        ...
        if ((parentComponentDef = componentsContext._O_) && key != null) {
      ...
      if (isReceivingNewInput) {
        ...
        newProps = newProps || component.av_;
        widgetBody = component._N_;
        widgetState = component._v_;
