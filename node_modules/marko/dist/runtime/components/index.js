...
function addComponentsFromContext(componentsContext, componentsToHydrate) {
  ...
  for (var i = 0; i < len; i++) {
    ...
    var flags = componentDef._G_;
    var isLegacy = componentDef.al_;

    var state = component.state;
    var input = component.input || 0;
    var typeName = component.typeName;
    var customEvents = component.S_;
    var scope = component.L_;
    var bubblingDomEvents = component.R_;
    ...
    if (isLegacy) {
      ...
      if (!(flags & FLAG_WILL_RERENDER_IN_BROWSER) || flags & FLAG_OLD_HYDRATE_NO_CREATE) {
        ...
        component.S_ = undefined;
        component.L_ = undefined;
        component.R_ = undefined;
        component._V_ = undefined;
  ...
  var nestedContexts = componentsContext._P_;
...
function getInitComponentsData(out, componentDefs) {
  ...
  const TYPE_INDEX = 1;
  const typesLookup = $global.an_ || ($global.an_ = new Map());
  let newTypes;
