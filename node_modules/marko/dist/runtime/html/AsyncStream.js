...
var escapeXmlString = escapeXmlHelper.aW_;
...
var proto = AsyncStream.prototype = {
  ...
  _doFinish: function () {
    ...
    if (state.writer.end) {
      ...
      state.events.emit("finish", this.aY_());
    }
  },
  ...
  aV_: function (tagName, elementAttrs, key, componentDef, props) {
  ...
  aT_: function (name, elementAttrs, key, componentDef, props) {
