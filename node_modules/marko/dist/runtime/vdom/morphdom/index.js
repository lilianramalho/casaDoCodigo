...
var normalizeComponentKey = componentsUtil.aM_;
var VElement = require("../vdom").be_;
var virtualizeElement = VElement.bU_;
var morphAttrs = VElement.bV_;
...
var insertBefore = helpers.aO_;
var insertAfter = helpers.aP_;
var nextSibling = helpers.b_;
var firstChild = helpers.a_;
var removeChild = helpers.aQ_;
var createFragmentNode = fragment.ao_;
var beginFragmentNode = fragment.cb_;
...
function morphdom(fromNode, toNode, doc, componentsContext) {
  ...
  function insertVirtualNodeBefore(vNode, key, referenceEl, parentEl, ownerComponent, parentComponent) {
    var realNode = vNode.bD_(doc, parentEl.namespaceURI);
    insertBefore(realNode, referenceEl, parentEl);

    if (vNode.bG_ === ELEMENT_NODE || vNode.bG_ === FRAGMENT_NODE) {
      if (key) {
  ...
  function insertVirtualComponentBefore(vComponent, referenceNode, referenceNodeParentEl, component, key, ownerComponent, parentComponent) {
    var rootNode = component.O_ = insertBefore(createFragmentNode(), referenceNode, referenceNodeParentEl);
  ...
  function morphComponent(component, vComponent) {
    morphChildren(component.O_, vComponent, component);
  }
  ...
  function morphChildren(fromNode, toNode, parentComponent) {
    ...
    outer: while (curToNodeChild) {
      ...
      curToNodeType = curToNodeChild.bG_;
      curToNodeKey = curToNodeChild.bH_;
      ...
      var ownerComponent = curToNodeChild.aJ_ || parentComponent;
      ...
      if (curToNodeType === COMPONENT_NODE) {
        ...
        if ((matchingFromComponent = existingComponentLookup[component.id]) === undefined) {
          ...
          if (matchingFromComponent.O_ !== curFromNodeChild) {
            if (curFromNodeChild && (fromComponent = componentByDOMNode.get(curFromNodeChild)) && globalComponentsContext._T_[fromComponent.id] === undefined) {
              // The component associated with the current real DOM node was not rendered
              // so we should just remove it out of the real DOM by destroying it
              curFromNodeChild = nextSibling(fromComponent.O_);
            ...
            insertBefore(matchingFromComponent.O_, curFromNodeChild, fromNode);
          } else {
            curFromNodeChild = curFromNodeChild && nextSibling(curFromNodeChild);
          }

          if (!curToNodeChild.bI_) {
            morphComponent(component, curToNodeChild);
          }
        }
        ...
        // up elements
        curToNodeKey = (keySequences[referenceComponent.id] || (keySequences[referenceComponent.id] = new KeySequence()))._J_(curToNodeKey);
        ...
        if (curFromNodeKey === curToNodeKey) {
          ...
          if ((matchingFromEl = referenceComponent.p_[curToNodeKey]) === undefined) {
            if (isHydrate === true && curFromNodeChild) {
              if (curFromNodeChild.nodeType === ELEMENT_NODE && caseInsensitiveCompare(curFromNodeChild.nodeName, curToNodeChild.bO_ || "")) {
                curVFromNodeChild = virtualizeElement(curFromNodeChild);
                curVFromNodeChild.bO_ = curToNodeChild.bO_;
                keysByDOMNode.set(curFromNodeChild, curToNodeKey);
                morphEl(curFromNodeChild, curVFromNodeChild, curToNodeChild, curToNodeKey, ownerComponent, parentComponent);
                curToNodeChild = toNextSibling;
                curFromNodeChild = fromNextSibling;
                continue;
              } else if (curToNodeChild.bG_ === FRAGMENT_NODE && curFromNodeChild.nodeType === COMMENT_NODE) {
            ...
            if (!curToNodeChild.bI_) {
              ...
              if (compareNodeNames(curVFromNodeChild, curToNodeChild)) {
                if (fromNextSibling === matchingFromEl) {
                  ...
                  if (toNextSibling && toNextSibling.bH_ === curFromNodeKey) {
                    // Single element swap
      ...
      while (curFromNodeChild) {
        ...
        if (fromComponent = componentByDOMNode.get(curFromNodeChild)) {
          ...
          if (!globalComponentsContext._T_[fromComponent.id]) {
            destroyComponent(fromComponent);
          }
          ...
          if (curFromNodeType === ELEMENT_NODE) {
            ...
            if (curVFromNodeChild === undefined) {
              if (isHydrate === true) {
                ...
                if (caseInsensitiveCompare(curVFromNodeChild.bO_, curToNodeChild.bO_)) {
                  curVFromNodeChild.bO_ = curToNodeChild.bO_;
                }
              } else {
            ...
            } else if (curFromNodeKey = curVFromNodeChild.bH_) {
            ...
            if (curFromNodeChild.nodeValue !== curToNodeChild.bF_) {
              curFromNodeChild.nodeValue = curToNodeChild.bF_;
            }
          }
        }
    ...
    if (fromNode.ca_) {
      ...
      while (curFromNodeChild && curFromNodeChild !== fragmentBoundary) {
        ...
        if (!curFromNodeKey || isAutoKey(curFromNodeKey)) {
          ...
          referenceComponent = curVFromNodeChild && curVFromNodeChild.aJ_;
        }
  ...
  function morphEl(fromEl, vFromEl, toEl, toElKey, ownerComponent, parentComponent) {
    ...
    var constId = toEl.bQ_;
    if (constId !== undefined && vFromEl.bQ_ === constId) {
      return;
    }
